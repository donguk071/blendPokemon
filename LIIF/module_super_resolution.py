...
def make_high_resolution(img_path, resolution_width, resolution_height):
    demo.run(img_path = img_path, output_path = 'LIIF/outputs/output1.jpg', model_path = 'LIIF/edsr-baseline-liif.pth', resolution_width = resolution_width, resolution_height = resolution_height)
